...
measure_vars <- c(outer(c("cr_ac_mr", "cr_ac_spending", "ac_mr", "cs_spending", 
                          "ac_spending", "cs_spending_per_case", "cases", 
...
fwrite(dt, "./spending_cause_replaced_mort_rates_dex_gdp_aggregated_death_agg.csv")

dt_draw_0 <- dt[draw == 0, ]
fwrite(dt_draw_0, "./draw_0_spending_cause_replaced_mort_rates_dex_gdp_aggregated_death_agg.csv")
